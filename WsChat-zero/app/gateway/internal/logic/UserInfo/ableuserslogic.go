...
func NewAbleUsersLogic(ctx context.Context, svcCtx *svc.ServiceContext) *AbleUsersLogic {
	return &AbleUsersLogic{Logger: logx.WithContext(ctx), ctx: ctx, svcCtx: svcCtx}
}

func (l *AbleUsersLogic) AbleUsers(req *types.IdsReq) (resp *types.CommonResp, err error) {
	r, e := l.svcCtx.UserClient.AbleUsers(l.ctx, &userpb.AbleUsersRequest{UserIds: req.Ids})
	if e != nil {
